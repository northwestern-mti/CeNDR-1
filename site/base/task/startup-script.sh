...
curl "https://metadata.google.internal/computeMetadata/v1/instance/attributes/models" -H "Metadata-Flavor: Google" > models.py
curl "https://metadata.google.internal/computeMetadata/v1/instance/attributes/run_pipeline" -H "Metadata-Flavor: Google" > run_pipeline.py
