...
NSCALC_SERVICE_ACCOUNT_NAME = os.environ.get('NSCALC_SERVICE_ACCOUNT_NAME')
NSCALC_REPORT_BUCKET_NAME = os.environ.get('GOOGLE_CLOUD_REPORT_BUCKET_NAME')
NSCALC_WORK_BUCKET_NAME = os.environ.get('GOOGLE_CLOUD_WORK_BUCKET_NAME')

GOOGLE_CLOUD_PARENT_ID = f"projects/${GOOGLE_CLOUD_PROJECT_ID}/locations/${GOOGLE_CLOUD_REGION}"
NSCALC_SERVICE_ACCOUNT = f"${NSCALC_SERVICE_ACCOUNT_NAME}@${GOOGLE_CLOUD_PROJECT_NAME}.iam.gserviceaccount.com"
